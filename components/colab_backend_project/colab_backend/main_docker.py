...
from colab_backend.app import start
from colab_backend.environment import Configuration
...
def main():
    ...
    This function is used as the script `run_colab_backend` entry point within the
    `project.toml` file.
    """
    start(
